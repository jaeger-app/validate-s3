...
use JaegerApp\Validate\Rules\S3\Buckets\Writable;
...
class WritableTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('s3_bucket_writable', 'connection_field', $creds)->val(array(
    ...
    {
        $val = new Validate();
        $val->rule('s3_bucket_writable', 'connection_field', $this->getS3Creds())
            ->val(array(
